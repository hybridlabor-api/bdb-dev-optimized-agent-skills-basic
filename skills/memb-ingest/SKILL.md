...
```bash
/Users/timrennings/.gemini/mcps/memb-mcp/.venv/bin/python /Users/timrennings/bdb-dev/bdb-dev-optimized-agent-skills-basic/mcps/memb-mcp/memb_ingest.py "<TARGET_DIRECTORY>" --transcripts
```
