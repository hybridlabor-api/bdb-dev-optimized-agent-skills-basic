...
[![CI](https://github.com/hybridlabor-api/bdb-dev-optimized-agent-skills-basic/actions/workflows/ci.yml/badge.svg)](https://github.com/hybridlabor-api/bdb-dev-optimized-agent-skills-basic/actions)
[![NPM Version](https://img.shields.io/npm/v/@hybridlabor-api/bdb-dev-optimized-agent-skills-basic.svg)](https://www.npmjs.com/package/@hybridlabor-api/bdb-dev-optimized-agent-skills-basic)
[![runtime](https://img.shields.io/badge/node-20+-blue.svg)](https://github.com/hybridlabor-api/bdb-dev-optimized-agent-skills-basic)
...
{
  "projects": [
    "/Users/<your-username>/bdb-dev-optimized-agent-skills-basic",
...
- **Agent Skills Version (`bdb-dev-optimized-agent-skills-basic`)**: Includes all optimized skills, interactive MCP selection UI, and **active background daemons**. It automatically installs and orchestrates the `memB` local semantic memory engine and the `OpenWiki` self-documenting git-hooks. Best for fully autonomous, long-term project management.
...
> "Please run `npx -y @hybridlabor-api/bdb-dev-optimized-agent-skills-basic` to install the skills pack and configure the local MCP servers."
